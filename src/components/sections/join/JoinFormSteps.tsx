...
import { fieldInputClass } from "./form-field-styles";
import { isJoinStepComplete, JOIN_FORM_STEP_COUNT } from "./join-form-flow";
...
interface JoinFormProgressProps {
  activeStep: number;
  blockedMessage: string | null;
}

export function JoinFormProgress({ activeStep, blockedMessage }: JoinFormProgressProps) {
...
export interface JoinFormStepsProps {
  activeStep: number;
  canSubmit: boolean;
  form: JoinFormData;
  ids: string;
  ...
  setForm: Dispatch<SetStateAction<JoinFormData>>;
}

export function JoinFormSteps({
  activeStep,
  canSubmit,
  form,
  ids,
    ...
    <>
      <FormStepScreen active={activeStep === 0}>
        ...
        >
          ...
          <ContinueButton disabled={!isJoinStepComplete(0, form)} onClick={() => onNavigate(1)} />
        </FormSection>
      </FormStepScreen>
      ...
      <FormStepScreen active={activeStep === 3} delay={0.15}>
        ...
        >
          ...
          <ContinueButton onBack={() => onNavigate(-1)} onClick={() => onNavigate(1)} />
        </FormSection>
      </FormStepScreen>
